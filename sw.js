const CACHE="catalogo-inmuebles-v3";
const CORE=["./","./index.html","./styles.css","./properties-data.js","./app.js","./properties.json","./favicon.png","./icon-192.png","./icon-512.png","./hero-casa-azul-fuerte.png"];
